...
public class ModTags
{
    public static class Blocks
    {
        ...
        {
            return BlockTags.create(ResourceLocation.fromNamespaceAndPath(AestheticSurfaces.MOD_ID, name));
        }
    }
    ...
    public static class Items
    {
        ...
        {
            return ItemTags.create(ResourceLocation.fromNamespaceAndPath(AestheticSurfaces.MOD_ID, name));
        }
    }
}